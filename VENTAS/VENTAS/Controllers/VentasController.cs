...
namespace VENTAS.Controllers
{
    public class VentasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NoFactura,Fecha,Cantidad,Observaciones")] Ventas ventas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NoFactura,Fecha,Cantidad,Observaciones")] Ventas ventas)
        {
            if (id != ventas.Id)
            {
                return NotFound();
